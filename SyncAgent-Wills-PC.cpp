...
void FinishAgent::proceed() {
    ...
    cout << "done" //as you can see, done prints as soon as final competitors printed so the r.setPosition is called; continue from here with inserting position and printing results
